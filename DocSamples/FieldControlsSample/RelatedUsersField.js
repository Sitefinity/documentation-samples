Type.registerNamespace("SitefinityWebApp.FieldControlsSample");

SitefinityWebApp.FieldControlsSample.RelatedUsersField = function (element) {

    SitefinityWebApp.FieldControlsSample.RelatedUsersField.initializeBase(this, [element]);
...
SitefinityWebApp.FieldControlsSample.RelatedUsersField.prototype =
    {
        initialize: function () {
            SitefinityWebApp.FieldControlsSample.RelatedUsersField.callBaseMethod(this, "initialize");
        ...
        dispose: function () {
            SitefinityWebApp.FieldControlsSample.RelatedUsersField.callBaseMethod(this, "dispose");
            if (this._selectButton) {
...
SitefinityWebApp.FieldControlsSample.RelatedUsersField.registerClass("SitefinityWebApp.FieldControlsSample.RelatedUsersField", Telerik.Sitefinity.Web.UI.Fields.FieldControl);
